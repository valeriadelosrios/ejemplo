...
Respuestas ={
    0:["¡Hola! ¿En qué puedo ayudarte hoy? 😊",
      "¡Un gusto saldarte! ",
      "¡Hola! ¿Como estas?",
      ],
    1:["Hasta luego",
    ...
    2:["Soy una asistente virtual creada para ayudarte. 🤖",
       "¡Por supuesto! ¿Con que necesitas ayuda?",
       "Cuentame tu problema y buscare la mejor solución.",
       ],
    3:["Puedo ofecerte información o resolver tus dudas.",
    ...
    5:["Lo siento, no entiendo tu pregunta, puedes intentarlo de nuevo 🤔",
